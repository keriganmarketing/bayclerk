<header class="top">
        ...
        <div class="top-container">
            <div class="container d-md-flex justify-content-between">
                <div class="site-branding text-left d-inline-flex" >
                    ...
                    <div class="logo-text">
                        <p class="clerk-name">Firstname Lastname</p>
                        <p>County County, Florida<br>Clerk of Court</p>
                    </div>
                </div>
    ...
    <div v-if="howDoIOpen" class="mobile-menu sizable" ref="howdoiMenuContainer" :class="{ 'open': howDoIOpen }" >
        <div class="container d-none d-lg-block">
            <mega-menu :main-nav="<?php echo e(website_menu(6)); ?>" ></mega-menu>
        </div>
    </div>
    <div v-if="mobileHowDoIOpen" class="mobile-menu" ref="howdoiMenuContainer" :class="{ 'open': mobileHowDoIOpen }" >
        <mobile-menu :mobile-nav="<?php echo e(website_menu(6)); ?>" class="navbar-nav" ></mobile-menu>
    </div>
...
<div class="top-pad"></div><?php /**PATH C:\dev\clerk-starter-beta\public\themes\wordplate\views/partials/header.blade.php ENDPATH**/ ?>